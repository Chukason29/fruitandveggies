...
<body>
    ...
    <section id="fruit-veggies">
        <div id="fruit-veggies-left">
            <h2>WHY FRUITS AND VEGGIES?</h2>
        </div>
    ...
    <section id="fruit-hands">
        <div id="fruit-hands-left">
            <p class="best-fruit">BEST FRUITS AND VEGGIES IN THE COUNTRY</p>
            <h1 class="our-store">OUR STORE</h1>
            <h2 class="who-we-are">WHO WE ARE</h2>
            <div id="home-aboutus">
                <div id="home-aboutus-header">
                    <p>ABOUT</p>
                    <p>OUR MISSION</p>
                    <p>OUR VISION</p>
                </div>
                <div>
                    <p class="home-aboutus-body">
                    ...
                    <p class="home-aboutus-body hide">
                        Started since year 2019, with the aim to bring the best fruits
                        and vegetables from all over the world. with over a thosuand
                        species of fruits, vegetables, spices and even nuts. Fruits and
                        veggies have made it a goal to bring these fruits to Nigeria
